      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <div className="col-span-3 border rounded-md h-32 bg-gray-50 dark:bg-gray-800 flex items-center justify-center overflow-hidden">
              {artPreview ? (
                <img src={artPreview} alt="Art Preview" className="max-h-28 max-w-full object-contain" />
              ) : (
                "Artwork Preview"
              )}
            </div>
        ...
        <DialogFooter>
          {mintingComplete && <Confetti trigger={mintingComplete} />}
          {mintingComplete ? (
