...
export default function Home() {
  ...
  const handleScoreUpdate = (newScores: typeof scores) => {
    ...
    setUsedPrompt(currentPrompt) // Save the prompt used for this submission
        ...
        <header className="mb-8 bg-white dark:bg-gray-800 p-6 rounded-xl border-4 border-gray-300 dark:border-gray-700 shadow-lg">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="text-center md:text-left">
              <h1 className="text-4xl font-bold text-black dark:text-white mb-2">Vynk</h1>
            ...
            <div className="lg:col-span-2">
              <Card className="border-4 border-gray-300 dark:border-gray-700 rounded-xl shadow-lg overflow-hidden">
                ...
                <CardFooter className="flex justify-end bg-gray-200 dark:bg-gray-800 p-4">
                  <MintNFTButton disabled={!hasSubmitted} scores={scores} prompt={usedPrompt ?? currentPrompt} />
                </CardFooter>
              </Card>
            </div>
            ...
            <div>
              {hasSubmitted ? (
                <div className="space-y-6">
                  <ScoreDisplay scores={scores} prompt={usedPrompt ?? currentPrompt} />
                    ...
                    <Card className="border-4 border-gray-300 dark:border-gray-700 rounded-xl shadow-lg overflow-hidden">
                      ...
                      <CardContent className="p-2">
                        <NFTCard
                          ...
                          prompt={usedPrompt ?? currentPrompt}
